...
function handleFileUploadFixed(event) {
    ...
    let existingContent = document.getElementById('inputText').value;
    ...
    Array.from(files).forEach((file, index) => {
        ...
        reader.onload = function(e) {
            ...
            fileBadge.setAttribute('title', `Size: ${formatFileSize(file.size)}\nType: ${file.type || 'text/plain'}`);
...
function removeFileFixed(fileId) {
    ...
    console.log('File removed:', displayName);
}
