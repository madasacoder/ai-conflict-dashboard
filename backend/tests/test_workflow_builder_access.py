...
def test_no_https_localhost_references():
...
def test_no_upgrade_insecure_requests():
...
def test_workflow_builder_accessible_via_http():
...
def test_frontend_server_handles_ssl_gracefully():
...
def test_url_patterns(url, should_be_http):
